...
static const struct _dictionary_line dictionary[] = {
  ...
  {"timestamps_rfc3339", cfg_key_timestamps_rfc9557},
  {"timestamps_rfc9557", cfg_key_timestamps_rfc9557},
  ...
  {"telemetry_daemon_msglog_amqp_port", cfg_key_telemetry_msglog_amqp_port},
  ...
  {"telemetry_dump_amqp_port", cfg_key_telemetry_dump_amqp_port},
  ...
  {"sfacctd_counter_amqp_port", cfg_key_sfacctd_counter_amqp_port},
  ...
  {"bgp_daemon_ha_cluster_name", cfg_key_bgp_bmp_daemon_ha_cluster_name},
  {"bgp_daemon_ha_cluster_id", cfg_key_bgp_bmp_daemon_ha_cluster_id},
  {"bgp_daemon_ha_queue_message_timeout", cfg_key_bgp_bmp_daemon_ha_queue_message_timeout},
  {"bgp_daemon_ha_queue_max_size", cfg_key_bgp_bmp_daemon_ha_queue_max_size},
  ...
  {"bgp_daemon_msglog_amqp_port", cfg_key_bgp_daemon_msglog_amqp_port},
  ...
  {"bgp_table_dump_amqp_port", cfg_key_bgp_daemon_table_dump_amqp_port},
  ...
  {"bmp_daemon_ha_cluster_name", cfg_key_bgp_bmp_daemon_ha_cluster_name},
  {"bmp_daemon_ha_cluster_id", cfg_key_bgp_bmp_daemon_ha_cluster_id},
  {"bmp_daemon_ha_queue_message_timeout", cfg_key_bgp_bmp_daemon_ha_queue_message_timeout},
  ...
  {"bmp_daemon_msglog_amqp_port", cfg_key_bmp_daemon_msglog_amqp_port},
  ...
  {"bmp_dump_amqp_port", cfg_key_bmp_daemon_dump_amqp_port},
