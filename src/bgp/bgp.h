...
struct bgp_misc_structs {
  ...
  u_int32_t (*route_info_modulo)(struct bgp_peer *, rd_t *, path_id_t *, struct bgp_msg_extra_data *, int);
...
extern void bgp_tag_clear(bgp_tag_t *);
extern void bgp_tag_init_find(struct bgp_peer *, struct sockaddr *, struct bgp_info *, bgp_tag_t *, int);
...
extern u_int32_t (*bgp_route_info_modulo)(struct bgp_peer *, rd_t *, path_id_t *, struct bgp_msg_extra_data *, int);
